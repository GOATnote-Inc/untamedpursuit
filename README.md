...
| 2 | *(TBD)* | Era 1 | The Voyage West | Drafting — 3 of 26 chapters |
...
*Book 2: ~9,770 words drafted* · *Series total: ~85,040 words*
<!-- PROGRESS:END -->

<!-- METRICS:START -->
### Series Dashboard

**9 books planned** · **2 in progress** · **~85,040 of ~500,000 estimated words**
...
|---|---|---|---|
| **Chapters** | 24 of 36 outlined | 3 of 26 outlined | -- |
| **Words** | 75,270 | 9,770 | -- |
| **POV** | Clara (15) · Samuel (9) | Clara (3) | -- |

*27 chapters · 85,040 words · 3,149 avg words/chapter*
<!-- METRICS:END -->
