# Open Threads & Mysteries — Untamed Pursuit

> Every promise made to the reader. Track foreshadowing, questions, planted clues, and unresolved tensions.
> Sorted by when they were planted. Status: `planted` | `developing` | `resolved` | `subverted` | `abandoned`
...
- **Clues given so far**:
  ...
  - Lily's weapons training ("Not out of fear... Out of choice") — foreshadows her killing Thomas
- **Resolution**: Jack was right. Thomas betrays Clara. Lily kills Thomas. The specifics of the betrayal are TBD, but the arc is: trusted friend → jealous friend → betrayer → killed by Lily.
- **Thematic resonance**: Clara's blindspot was trusting the familiar. Lily's gentleness conceals steel. Jack's instinct was sharper than Clara's judgment.

### 2. The Venezuela Crisis
- **Status**: planted
- **Planted**: One_year_after_Venezuela_crisis (referenced)
- **Description**: A major crisis involving the team. Referenced as a pivotal event but never shown on page. The story picks up "one year after."
- **Clues given so far**:
  - Eve's team participated
  - Significant enough to measure time from ("one year after")
  - Madison's tech platform proposal follows in its wake
- **Resolution plan**: Should be shown or detailed in a future book.

### 3. Eve's Canyon Ambush
- **Status**: planted
- **Planted**: Jessie_considers_Art (prompt notes: "Create transition that leads to Eve assaulted in a canyon")
- **Description**: Eve takes the canyon route south to investigate suspicious troop movements while Jessie goes to Reno. The prompt notes indicate Eve will be attacked.
- **Clues given so far**:
  - Clara mentioned suspicious troop movements
  - Eve sends Ghost with Jessie instead of keeping him
  - Eve is alone with Storm for the first time in the narrative
- **Resolution plan**: Major action sequence. Eve fights alone, proving her capability without her support network.

### 4. Clara's Full Network Scope
- **Status**: developing
- **Planted**: Multiple files (Episode I, Part_One, Unit_creation)
- **Description**: Clara's network extends across continents — Pacific trading connections, intelligence operations, military contacts, civilian fronts. The full scope is never revealed.
- **Clues given so far**:
  - Philadelphia docks + Golden Compass + Glass Garden
  - 14 specialized missions for Samuel over 7 years
  - Team members planted in Eve's life for years (Morgan, Colt, etc.)
  - Madison's platform as unknowing cover
  - "Protection on a scale most people never see"
...
- **Status**: planted
- **Planted**: Jessie_considers_Art
- **Description**: Jessie has a romantic/sexual relationship with Captain Andrews, a military officer stationed near Reno. He has access to military intelligence and resources.
- **Clues given so far**:
  - Three days' leave, private cabin in the woods
  - Jessie "rarely speaks about" him
  - Military connections could serve the network
- **Resolution plan**: Andrews may become an operational asset or a complication if his military loyalty conflicts with the network's goals.

### 7. Deliberate Well Poisoning
- **Status**: planted
- **Planted**: Jack_meet_Clara
- **Description**: Jack discovers chemical tests in soil near a town's well. The fever outbreak is deliberate — someone is "testing delivery methods for something worse."
- **Clues given so far**:
  - Chemical residue found near the well
  - Fever outbreak traced to poisoning, not natural causes
  - Clara's organization offers 5x bounty for live capture (want intelligence, not vengeance)
  - "These people wanted information more than vengeance"
- **Resolution plan**: Biological/chemical warfare plot. The perpetrators connect to a larger conspiracy.

### 8. Durand Family Conspiracy
- **Status**: developing
- **Planted**: outline_for_fierce_11_27 (FIERCE 4-act outline)
- **Description**: The Durand family is the primary antagonist faction in the FIERCE Book 1 outline. Thomas Mitchell is himself a Durand by blood — his connection is through his own family, not through Thomas Arlington.
- **Clues given so far**:
  - Thomas Mitchell reveals his Durand connection in the tunnels (Act II)
  - Durand faction attacks Glass Garden
  - Thomas Mitchell ultimately confronts his own family
  - Full assault on Glass Garden in Act II
...
- **Status**: planted
- **Planted**: outline_for_fierce_11_27 (FIERCE Act II)
- **Description**: The Glass Garden is assaulted by enemies who know its defenses. Someone with intimate knowledge of the estate betrayed its secrets.
- **Clues given so far**:
  - Full assault targets the Glass Garden specifically
  - Attackers know the layout well enough to mount an effective attack
  - Thomas Mitchell (Eve's era, a Durand by blood) is the obvious suspect due to his family connection
  - Note: Thomas Arlington (Clara's era intelligence chief) is a separate character and not implicated here
- **Resolution plan**: Thomas Mitchell is cleared; the real traitor is TBD.

---

## Potential Threads (Need Author Decision)

### Eve's "First Mission"
- Referenced in Clara_with_Eve_on_her_death_bed — Eve is away on her first mission when Clara's condition worsens.
- What was this mission? Connects to the reveal in Part_One_Summer_Memories.

### "The Man in New York"
- Referenced in Clara_teaching_awareness_16yr_Eve — Eve thinks of "the man in New York" during her reflection.
- A formative incident involving ignorance/recklessness. Never shown.

### Eve's Interest in Fabrics and Design
- Eve_and_shooting_with_Jack fragment: "Neither were what seemed to captivate her. It was the bright colors of fabrics and practical gear."
- Is this a recurring thread? Does Eve's creative side get expressed?

### Silas's Dual Nature — RESOLVED / ABANDONED
- **Resolution**: Silas Kane (the antagonist, wolf-like hunter) is from the abandoned alternate version of the story and is non-canon. Canon Silas is the team member only — quiet grace, guard duty, wind-reading. There is no dual nature; the conflict was an artifact of two drafts.
...
<!-- None yet — populate as the author resolves discrepancies and drafts chapters. -->

## Subverted Threads

<!-- None yet — populate as the story develops. -->
