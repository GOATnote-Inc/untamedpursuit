...
died: ""
status: alive
first_appearance: "book-02, ch-05"
last_appearance: ""
pov_character: false
---
...
Brown-skinned, weathered by the Pacific. Speaks English with a Spanish accent that flattens consonants and lengthens vowels. Practical bearing — a man whose ship is his livelihood and whose livelihood depends on accurate risk assessment.
...
|-----------|-------------|---------|
| Clara Chen | Passenger / respected | Recognizes her authority. Accepts her security modifications to his ship (galley bolt). Runs a practical operation and respects the same in others. |
| Samuel Taylor | Passenger / business | Negotiated passage. Interaction is transactional but professional. |
